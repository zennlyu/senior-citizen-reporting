...
import Ch05 from "../ch-options/Ch05";
        ...
        <>
            ...
            <Container>
                <div id="typography">
                    <h4><br/><br/>
                        ...
                        <br/>
                        <br/>
                        新冠疫情的出现，使得还有选择“余地”的老年人群体不得不走上智能化道路，健康码、行程码、扫码取件、网上预约......老年人群体开始了一场“数字长征”。<br/><br/><br/><br/>
                    </h4>
                </div>
            </Container>
            <Ch01 />
            <Container className="tim-container">
                <div id="typography">
                    <Row>
                        ...
                        <br/>
                        <h2 className="text-info"><br/><br/><b>“触网”考验</b></h2>
                        <h4>
                            年轻一代作为互联网的原住民，熟练地享受着互联网带来的生活方方面面的便捷，如网上点餐、预约挂号，甚至因疫情足不出户也能工作学习......而那些从未接触过互联网或难以学习新技术的老年人，却身陷“数字鸿沟”的困境。<br/><br/>
                        </h4>
                        <div>
                            <img src={require("assets/img/silverDilemma/statistics/2016年至2021年网民年龄结构变化.gif").default}
                            /><br/><br/>
                        </div>
                        <h4>
                    ...
                    <Col>
                        <a href="examples/landing.html" target="_blank">
                            <img
                                alt="..."
                                className="img-rounded img-responsive"
                                src={require("assets/img/silverDilemma/老年人.png").default}
                            />
                        </a>
                    </Col>
                    <Col className="ml-auto">
                        <a href="examples/landing.html" target="_blank">
                            <img
                                alt="..."
                                className="img-rounded img-responsive"
                                src={require("assets/img/silverDilemma/老年人2.png").default}
                            />
                        </a>
                    </Col>
                </Row>
            ...
            <Container><br/><br/>
                <div id="typography">
                    <Row>
                        <h4>
                            老年化遇上数字化，这并非是一场不可调和的矛盾。当我们在数字化的进程中享受着极度的狂欢时，不妨驻足回望，带一带步履蹒跚的中年人，搀一搀奋力前行的老年人。让那双小时候搀扶你行走的大手在数字时代也能有温暖的触摸，未来很远，我们很近。<br/><br/><br/><br/>
                        </h4>
                    </Row>
                </div>
